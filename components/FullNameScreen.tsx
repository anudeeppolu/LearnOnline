    ...
    <>
      ...
      <SafeAreaView>
        <View
            ...
            <View style={styles.progressBarWrapper}>
              <View style={styles.progressBarContainer}>
                {totalScreens?.map((_, index) => (
                  ...
                  style={[
                    styles.progressBar,
                    index ==  0 ? styles.progressBarFilledColor : {backgroundColor:themeBasedStyle.color},
                  ]}></View>
                ))}
              </View>
          ...
          {/* Next Button */}
          <TouchableOpacity style={styles.nextButton} onPress={() => {navigation.push('EmailAddress')}}>
