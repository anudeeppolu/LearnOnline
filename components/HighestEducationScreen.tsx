...
export default function HighestEducationScreen({navigation}: any) {
    ...
    <>
      ...
      <SafeAreaView>
        <View
          ...
          <View>
            ...
            <View style={styles.progressBarWrapper}>
              ...
              {totalScreens?.map((_, index) => (
                  ...
                  style={[
                    styles.progressBar,
                    (index ==  0 || index ==  1 || index == 2 || index == 3)  ? styles.progressBarFilledColor : {backgroundColor:themeBasedStyle.color},
                  ]}></View>
                ))}
              </View>
          ...
          {/* Next Button */}
          <TouchableOpacity style={styles.nextButton} onPress={() => {navigation.push('CurrentSector')}}>
